...
export const EXPERTISE_CATEGORIES: ExpertiseCategory[] = [
  {
    ...
    description:
      "Services, APIs, and the concurrency/data patterns that keep them consistent under load.",
    icon: "Server",
    techSlugs: [
      "go",
      "php",
  ...
  },
  {
    ...
    description:
      "Databases, queues, caching, and the plumbing that lets independent services stay in sync.",
    icon: "Database",
    techSlugs: [
      "postgres",
      "mysql",
  ...
  },
  {
    ...
    label: "Frontend",
    description:
      "Interfaces built on the same engineering rigor as the backends behind them.",
  ...
  },
  {
    ...
    label: "AI & Cloud",
    description:
      "Semantic search, embeddings, and the cloud platforms projects actually ship to.",
    icon: "Sparkles",
  ...
  },
  {
    ...
    description:
      "The day-to-day tooling around version control, design handoff, and hardware.",
    icon: "Wrench",
