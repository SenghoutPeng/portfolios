...
export const PROJECTS: Project[] = [
  {
    ...
    title: "MyLMS",
    tagline:
      "Learning Management System planned and built by a 10 third-year engineer team, built in a 2-month sprint window",
    description:
    ...
    howItWorks: [
      {
        step: "1",
        title: "Director Onboards",
        description:
          "Bulk invite uservia CSV, triggering automatic invite emails",
      },
      {
        step: "2",
        title: "Lecturer Builds Content",
        description:
          "Structures lessons and assessments, choosing self-paced or scheduled delivery",
      },
      {
        step: "3",
        title: "Student Progresses",
        description:
    ...
    challenges: [
      ...
      },
      {
        ...
        problem:
          "Coordinating team across frontend, backend, API, UI/UX, and DevOps under a fixed 2-month, budget-capped timeline",
        solution:
      ...
      },
      {
        ...
        problem:
          "Keeping independent Go microservices and their own databases in sync without tight coupling using gRPC communication",
        solution:
  ...
  },
  {
    ...
    title: "STEM-ArKH+",
    tagline:
      "Refactoring a closed contest archive into an open, AI-readable repository",
    description:
    ...
    howItWorks: [
      {
        step: "1",
        title: "Contributor Submits",
        description:
          "Students and educators upload project details, files, and metadata through the submission portal",
      },
      {
        step: "2",
        title: "Reviewer Approves",
        description:
          "Judges and admins review submissions before publishing, assigning domain and theme tags",
      },
      {
        step: "3",
        title: "System Indexes",
        description:
          "Approved projects are embedded with Gemini and indexed in Meilisearch for semantic search",
      },
      {
        step: "4",
        title: "Public Discovers",
        description:
          "Search engines, AI tools, and visitors browse the archive by topic, school, or event",
      },
    ],
    challenges: [
      {
        ...
        problem:
          "The prior platform prioritized security over visibility, rendering pages unreadable by search engines and AI tools",
        solution:
          "Restructured the backend around open indexing and server-rendered public pages, without weakening access control for private data",
        icon: "Unlock",
      },
      {
        title: "Inconsistent Legacy Data",
        problem:
          "Years of past STEMEOC projects existed in inconsistent, unstructured formats across different competitions",
        solution:
          "Built a metadata schema and tagging framework, then ran a pilot archive upload to normalize historical projects",
        icon: "Database",
      },
      {
        title: "Contributor Engagement",
        problem:
          "Participants who didn't win a competition often left with no lasting record of their work",
        solution:
          "Added a recognition module that publishes every contributor's profile and project, not just winners",
        icon: "Award",
      },
    ],
  },
    ...
    howItWorks: [
      {
        ...
        title: "Embed Query",
        description:
          "User query is converted into embeddings using the all-MiniLM model.",
      },
      {
        step: "2",
        title: "Retrieve",
        description:
          "Chroma DB finds the most relevant document chunks via cosine similarity.",
      },
      {
        step: "3",
        title: "Generate Answer",
        description:
          "The LLM generates a grounded answer citing the retrieved sources.",
      },
    ],
    challenges: [
      {
        ...
        problem:
          "Running embedding models in a Dockerized environment with limited CPU specs.",
        solution:
          "Used the lightweight all-MiniLM-L6-v2 model and an ephemeral Chroma DB for fast, low-memory performance.",
        icon: "Cpu",
      },
      {
        title: "Hallucination Prevention",
        problem:
          "Ensuring the LLM answers strictly based on the provided backend knowledge base.",
        solution:
          "Implemented strict system prompts to ground answers and built an Extractive mode to verify retrieved context.",
        icon: "Brain",
      },
    ],
  },
